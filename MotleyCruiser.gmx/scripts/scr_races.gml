...
races[0,RACE_NAME] = "Human";
races[0,RACE_BASE_HP] = 10;
races[0,RACE_BASE_SPD] = 1;
races[0,RACE_SPR] = spr_human;
races[0,RACE_SPR_FML] = spr_human_fml;
races[0,RACE_SEXES] = 2;
...
races[2,RACE_NAME] = "Hurgan";
races[2,RACE_BASE_HP] = 30;
races[2,RACE_BASE_SPD] = 1;
races[2,RACE_SPR] = spr_hurgan3; 
races[2,RACE_SPR_FML] = noone;
races[2,RACE_SEXES] = 1;

races[3,RACE_NAME] = "Flowridian";
races[3,RACE_BASE_HP] = 15;
races[3,RACE_BASE_SPD] = 1;
races[3,RACE_SPR] = spr_flowridian;
races[3,RACE_SPR_FML] = spr_flowridian_fml;
races[3,RACE_SEXES] = 2;

races[4,RACE_NAME] = "Androne";
races[4,RACE_BASE_HP] = 10;
races[4,RACE_BASE_SPD] = 1;
races[4,RACE_SPR] = spr_androne;
races[4,RACE_SPR_FML] = spr_androne_fml;
races[4,RACE_SEXES] = 2;

races[5,RACE_NAME] = "Pudning";
races[5,RACE_BASE_HP] = 12;
races[5,RACE_BASE_SPD] = 1;
races[5,RACE_SPR] = spr_pudning;
races[5,RACE_SPR_FML] = noone;
races[5,RACE_SEXES] = 1;
...
races[7,RACE_SPR_FML] = noone;
races[7,RACE_SEXES] = 1;
