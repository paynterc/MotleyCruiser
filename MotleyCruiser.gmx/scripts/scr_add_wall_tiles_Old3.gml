    ...
    for(var xx = 0; xx < width; xx++){
        if(global.grid[# xx, yy] == FLOOR){
            ...
            if(global.grid[# xx+1, yy] == WALL){
                // RIGHT
                tile_add(wall_tile, 0, 0, CELL_WIDTH, CELL_HEIGHT, (xx+1)*CELL_WIDTH, yy*CELL_HEIGHT, -1);
            ...
            if(global.grid[# xx, yy+1] == WALL){
                // BOTTOM
                if(global.grid[# xx, yy+2] == WALL){
                    tile_add(wall_tile, 0, 0, CELL_WIDTH, CELL_HEIGHT, xx*CELL_WIDTH, (yy+1)*CELL_HEIGHT, -1);
                }else{
                    tile_add(wall_tile, 0, CELL_HEIGHT, CELL_WIDTH, CELL_HEIGHT, xx*CELL_WIDTH, (yy+1)*CELL_HEIGHT, -1);
                }
            ...
            if(global.grid[# xx+1, yy-1] == VOID){
                // TOP RIGHT
                tile_add(wall_tile, 0, 0, CELL_WIDTH, CELL_HEIGHT, (xx+1)*CELL_WIDTH, (yy-1)*CELL_HEIGHT, -1);
            }
            if(global.grid[# xx-1, yy-1] == VOID){
                // TOP LEFT
                tile_add(wall_tile, 0, 0, CELL_WIDTH, CELL_HEIGHT, (xx-1)*CELL_WIDTH, (yy-1)*CELL_HEIGHT, -1);
            ...
            if(global.grid[# xx+1, yy+1] == VOID){
                // BOTTOM RIGHT
                tile_add(wall_tile, 0, CELL_HEIGHT, CELL_WIDTH, CELL_HEIGHT, (xx+1)*CELL_WIDTH, (yy+1)*CELL_HEIGHT, -1);
            }
            if(global.grid[# xx-1, yy+1] == VOID){
                // BOTTOM LEFT
                tile_add(wall_tile, 0, CELL_HEIGHT, CELL_WIDTH, CELL_HEIGHT, (xx-1)*CELL_WIDTH, (yy+1)*CELL_HEIGHT, -1);
